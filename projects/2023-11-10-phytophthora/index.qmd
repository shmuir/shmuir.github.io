---
title: "Phytophthora presence in Southern Maryland coasal soils"
...
#| cap-location: margin
soil <- read_csv(here::here("projects", "2023-11-10-phytophthora/soil_collection.csv")) %>%
  rename(lon = long) 
...
salinity <- read_csv(here::here("projects", "2023-11-10-phytophthora" ,"soil_collection.csv")) %>%
...
phyto_join <- read_csv(here::here("projects", "2023-11-10-phytophthora" ,"plate_counts.csv")) %>%
...
phyto_mel <- read_csv(here::here("projects", "2023-11-10-phytophthora" ,"platecount.csv")) %>%
